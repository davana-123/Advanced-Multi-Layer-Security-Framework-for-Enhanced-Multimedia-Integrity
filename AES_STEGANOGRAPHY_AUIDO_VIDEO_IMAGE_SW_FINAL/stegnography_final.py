...
def submit():
    ...
    lbl=tk.Label(win,text=input_string,font=("elephant",10,"italic"),bg="white",fg="black")
    ...
    labelL1=Button(win,text="Embedding",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf", command=embed)
...
##    doneE=Label(win,text="Text Embedded successfully!!!",bg="white",fg="black",width=25,height=2,font=("times",18,"bold")).place(x=335,y=430)
...
def decode_string():
    ...
    if str(video_file) == str(InputVideo):
        ...
        for i in secret:
            Msgg += i
        print(Msgg)
        lbl=tk.Label(win,text=Msgg,font=("elephant",10,"italic"),bg="white",fg="black")
        lbl.place(x=900,y=550)
        f = open('Key.txt' ,'r')
        keyyy = f.read()
        f.close()
        Msg = aes_decrypt(Msgg, keyyy)#######################################################################################################################
        labelE=Label(win,text="Your Message is :   "+str(Msg),bg="white",fg="black",font=("times",14,"bold"),height=3).place(x=800,y=570)
##        resultL=join([i for i in secret])
##        print(resultL)
        print('break {}'.format(secret))
    else:
        print("File doesn't Matched")
        labelE=Label(win,text="Wrong Video Choosed ",bg="white",fg="black",font=("times",14,"bold")).place(x=1100,y=450)

    labelR1=Button(win,text="Exit",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf",command=exitwindow)
...
def submit1():
    ...
    if old_key == new_key and old_otp==check_otp:
        labelR1=Button(win,text="Extraction",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf",command=decode_string)
        labelR1.place(x=720,y=450)
    else:
        print('Entered wrong key')
        labelR1=Label(win,text="Entered wrong\n secret key \n or Entered Wrong OTP",bg="white",fg="black",width=20,height=3,font=("times",14,"bold"))
...
##    labelRF.configure(height=30)
    ...
    labels1=Label(win,text="Enter Otp",bg="white",fg="black",font=("times",16,"bold"))
    labels1.place(x=720,y=350)
    labelot1=Entry(win,text="",bg="white",fg="black",font=("times",16,"bold"))# ,show="*")
    labelot1.place(x=720,y=400)
    labelR1=Button(win,text="Submit",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf", command=submit1)
    labelR1.place(x=720,y=450)
...
##    labelLF.configure(height=30)
    ...
    # labelot=Entry(win,text="",bg="white",fg="black",font=("times",16,"bold"))# ,show="*")
    # labelot.place(x=40,y=450)

    

    Submit=Button(win,text="Submit",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf",command=submit)
...
##labelLF=Label(win,text="",bg="white",fg="black",width=40,height=15)
##labelLF.place(x=20,y=50)
labelL=Label(win,text="Encryption",bg="white",fg="black",font=("times",14,"bold"))
labelL.place(x=150,y=55)
labelL=Label(win,text="Menu",bg="white",fg="black",font=("times",14,"bold"))
labelL.place(x=25,y=55)


labelL1=Button(win,text="Browse i/p Video",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf",command=choose_vid)
labelL1.place(x=40,y=140)
labelL1=Button(win,text="Enter Secret Key",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf",command=inp)
labelL1.place(x=40,y=215)

##labelRF=Label(win,text="",bg="white",fg="black",width=40,height=15)
##labelRF.place(x=700,y=50)
labelL=Label(win,text="Decryption",bg="white",fg="black",font=("times",14,"bold"))
labelL.place(x=850,y=50)
labelR=Label(win,text="Menu",bg="white",fg="black",font=("times",14,"bold"))
labelR.place(x=705,y=55)

labelR1=Button(win,text="Load Embedded video",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf",command=choose_vide)
labelR1.place(x=720,y=100)
labelR1=Button(win,text="Secret key",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="#93aebf",command=inp1)
