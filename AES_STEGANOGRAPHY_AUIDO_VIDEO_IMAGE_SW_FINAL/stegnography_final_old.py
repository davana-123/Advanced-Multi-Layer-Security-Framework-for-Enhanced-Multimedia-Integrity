...
def submit():
    ...
    labelL1=Button(win,text="Embedding",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red", command=embed)
...
def decode_string():
    ...
    if str(video_file) == str(InputVideo):
        ...
        labelE=Label(win,text="Your Message is :  "+str(Msg),bg="white",fg="black",font=("times",14,"bold"),height=3).place(x=1120,y=450)
...
##        print(resultL)
    ...
    labelR1=Button(win,text="Exit",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red",command=exitwindow)
...
def submit1():
    ...
    if old_key == new_key:
        labelR1=Button(win,text="Extraction",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red",command=decode_string)
        labelR1.place(x=720,y=350)
    else:
        print('Entered wrong key')
        labelR1=Label(win,text="Entered wrong\n secret key",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"))
...
##    labelRF.configure(height=30)
    ...
    labelR1=Button(win,text="Submit",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red", command=submit1)
    labelR1.place(x=720,y=350)
...
##    labelLF.configure(height=30)
    ...
    Submit=Button(win,text="Submit",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red",command=submit)
...
labelL1=Button(win,text="Browse i/p Video",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red",command=choose_vid)
labelL1.place(x=40,y=140)
labelL1=Button(win,text="Enter Secret Key",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red",command=inp)
...
labelR1=Button(win,text="Load Embedded video",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red",command=choose_vide)
labelR1.place(x=720,y=100)
labelR1=Button(win,text="Secret key",bg="white",fg="black",width=20,height=2,font=("times",14,"bold"),activebackground="red",command=inp1)
